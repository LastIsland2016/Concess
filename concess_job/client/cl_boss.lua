...
function GestionEmployed()
    ...
    local option_player = {}
    lib.callback('Sacario:concess_employed', false, function(result)
                    ...
                    options = {
                        {
                            ...
                            onSelect = function()
                                ...
                                if closestPlayer then     
                                    ...
                                    if input then
                                        TriggerServerEvent('Sacario:concess_recruit', input[1])
...
function ModifyEmployed()
    local option = {}
    lib.callback('Sacario:concess_salaire_table', false, function(result)
        for k, v in pairs(result) do 
            lib.registerContext({
                id = 'modify_employed',
                ...
                options = {
                    {
                        ...
                        onSelect = function()
                            ...
                            if input then 
                                TriggerServerEvent("Sacario:concess_modify_grade", input[1], info.identifier)
                                lib.showContext('list_employed')
                            else 
                                lib.showContext('list_employed')
                            end 
                    ...
                    },
                    {
                        ...
                        onSelect = function()
                            TriggerServerEvent('Sacario:concess_delete_grade', info.identifier)
                        end 
                    },
                }
            })
                    ...
                    onSelect = function()
                        ...
                        if input then
                            ...
                            if v.grade == 4 and input[1] > Config.BossMenu.MaxSalaryBoss then
                                ...
                                somme = input[1]
                                TriggerServerEvent('Sacario:concess_change_salaire', somme, v.grade)
                            end 
                        end
                    end   
                })
...
function GestionFinance()
    ...
    lib.callback('Sacario:concess_money', false, function(result)
        if result then
            for k, v in pairs(result) do
                lib.registerContext({
                    id = 'list_finance',
                    ...
                    options = {
                        ...
                        },
                        {
                            ...
                            onSelect = function()
                                ...
                                if input then
                                    somme = input[1]
                                    TriggerServerEvent('Sacario:add_money_society', v.money, somme)
                                end
                            end
                        },
                        {
                            ...
                            onSelect = function()
                                ...
                                if input then
                                    somme = input[1]
                                    TriggerServerEvent('Sacario:remove_money_society', v.money, somme)
                                end
                            end
                        }
                    }
...
function GestionVeh()
    ...
    local statut = nil
    local iconColor = nil
    lib.callback("Sacario:concess_GetVehicleSociety",false, function(result)
        if #result > 0 then 
            for k, v in pairs(result) do
                if v.stored == 0 then 
                    statut = 'Sortie'
            ...
            options = {
                {
                    ...
                    onSelect = function()
                        ...
                        TriggerServerEvent('Sacario:concess_SellVehicleSociety', plate, name, society)
                    end
                },
            ...
            options = {
                ...
                }, 
                {
                    ...
                    onSelect = function()
                        ...
                        TriggerServerEvent('Sacario:concess_CautionVehicleSociety', plate)
                            lib.notify({
                                title = 'Garage',
